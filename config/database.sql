...
('HO2A', 'Ion Cannon', 'Hoth - Imperial Invasion', 2, 1, 1900000, 19800000, 55000000, 'Ion Cannon Blast', 'HO3A:HO4A:HO5A', 'Rebels:HRSoldier', null, 2, 43000, 72000, 115000, 172000, 243000, 329000, 120000, 120000, 120000, 120000, 180000, 180000, -3240000, 14660000, 49860000, 90670000, 'These platoons affect the next 3 ship territories! In order to maximize star count everyone will require the ion cannon during thier ship battles.'),
